...
public class DonHang implements Parcelable {
    ...
    public static final Creator<DonHang> CREATOR = new Creator<DonHang>() {
        @Override
        public com.example.smartwatch.Object.DonHang createFromParcel(Parcel in) {
            return new com.example.smartwatch.Object.DonHang(in);
        }

        @Override
        public com.example.smartwatch.Object.DonHang[] newArray(int size) {
            return new com.example.smartwatch.Object.DonHang[size];
        }
    };
