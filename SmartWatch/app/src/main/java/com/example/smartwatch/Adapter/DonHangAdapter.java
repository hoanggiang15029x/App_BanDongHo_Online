...
import com.example.smartwatch.Activity.CTDonHangActivity;
import com.example.smartwatch.Activity.Fragment.ChoDuyetFragment;
import com.example.smartwatch.Activity.MainActivity;
...
public class DonHangAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (donHang.trangThai.equals("Chờ duyệt")) {
            button_duyetDon.setVisibility(View.GONE);
        }
        if (donHang.trangThai.equals("Đang giao")) {
            button_huyDon.setVisibility(View.GONE);
        }
        if (donHang.trangThai.equals("Đã giao")) {
            button_duyetDon.setVisibility(View.GONE);
            button_huyDon.setVisibility(View.GONE);
        }
        if (donHang.trangThai.equals("Đã hủy")) {
            button_duyetDon.setVisibility(View.GONE);
            button_huyDon.setVisibility(View.GONE);
        }
        ...
        button_duyetDon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                delete("XÁC NHẬN ĐƠN HÀNG","Xác nhận đã giao đơn hàng!",donHang,"Đã giao", list,position);
            }
        });
